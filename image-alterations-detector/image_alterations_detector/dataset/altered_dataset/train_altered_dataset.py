...
def train_altered_descriptors():
    ...
    multi_clf_matrices.create_model(x_train_matrices_descriptors.shape[1], layer1=100, layer2=50, activation='tanh',
                                    dropout=0.5)
    multi_clf_matrices.fit(x_train_matrices_descriptors, y_train_matrices_descriptors,
                           class_weight={0: class_weights_matrices[0], 1: class_weights_matrices[1]}, grid_search=False)
    # Evaluate and save
    ...
    multi_clf_lbp.create_model(x_train_lbp_descriptors.shape[1], layer1=10, layer2=None, activation='tanh', dropout=0.3)
