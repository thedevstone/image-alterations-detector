...
def train_altered_descriptors():
    ...
    multi_clf_matrices.create_model(x_train_matrices_descriptors.shape[1], layer1=100, layer2=150, activation='tanh',
                                    dropout=0.5)
    ...
    multi_clf_lbp.create_model(x_train_lbp_descriptors.shape[1], layer1=500, layer2=50, activation='tanh', dropout=0.3)
