...
def draw_delaunay_alterations(source_image, dest_image, animate=True) -> np.ndarray:
    ...
    for idx, t in enumerate(t1s):
        ...
        cv2.line(source_out, tri_point1, tri_point2, delaunay_color, 1, cv2.LINE_AA, 0)
        cv2.line(source_out, tri_point2, tri_point3, delaunay_color, 1, cv2.LINE_AA, 0)
        cv2.line(source_out, tri_point3, tri_point1, delaunay_color, 1, cv2.LINE_AA, 0)
